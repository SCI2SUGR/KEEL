...
public class Parameters implements Serializable {
    ...
    public void writeScripts(String path, String baseName, String methodName,
        ...
        for (i = 0; i < ((Vector) (set.elementAt(0))).size(); i++) {
            ...
            for (j = 0; j < times; j++) {
                 ...
                 ***************  EDUCATIONAL KEEL  ****************************
                 **************************************************************/
                if (methodName.startsWith("IS-") || methodName.startsWith("IG-") || pre == false) {
    ...
    public void writeTestScripts(String path, String baseName,
        ...
        for (j = 0; j < n_exe; j++) {
             ...
             ***************  EDUCATIONAL KEEL  ****************************
             **************************************************************/
            if (methodName.equals("Vis-Clas-Tabular")) {
             ...
             ***************  EDUCATIONAL KEEL  ****************************
             **************************************************************/
            } else if (methodName.equalsIgnoreCase("Vis-Clas-General") || methodName.equalsIgnoreCase("Vis-Regr-General")) {
                fichero += "outputDataTabular = ";
                /***************************************************************
                 ***************  EDUCATIONAL KEEL  ****************************
                 **************************************************************/
