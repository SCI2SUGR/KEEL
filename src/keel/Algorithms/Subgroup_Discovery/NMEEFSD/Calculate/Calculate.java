...
public class Calculate {
    ...
    * </p>
    * @param input_file         Fichero to capture
    ...
    **/
    ...
    throws IOException   {
       ...
       try {
        ...
        //StCalculate.Data.clearInstances();
        //Attributes.clearAll();
    ...
    * </p>
    * @param nFile      Files of the rules obtained by the algorithm
     * @throws java.io.IOException if the file can not be read.
    **/
                    ...
                    if (tok.equalsIgnoreCase("generated")) {
                        ...
                        if (ValorVar.equalsIgnoreCase("label")) {
                            ...
                            do {
                                ...
                                contents += "\t" + NombreVar + "(" + NumVar + ") = etiqueta " + ValorVar + " - " + ValorNum + "\n";
                            ...
                            do {
                                ...
                                contents += "\t" + NombreVar + "(" + NumVar + ") = " + ValorVar+ " - " + ValorNum + "\n";
                                StCalculate.poblac.setCromElem(StCalculate.NumReglasGeneradas-1, NumVar, ValorNum, 1);
                                if (tokens.hasMoreTokens())
                                    ValorVar = tokens.nextToken();
                                else
                        ...
                        contents+= "Consecuente " + ValorCons + " - " + ValorClase + "\n";
                        ...
                        contents += "Ejemplos de la clase: " + StCalculate.poblac.getIndivTotalClass(StCalculate.NumReglasGeneradas-1) + "\n";
    ...
    * </p>
    * @param nFile              Files of rules obtained by the algorithm
    * @return                   The number of rules obtained by the algorithm
     * @throws java.io.IOException if the file can not be read.
    **/
     ...
     * @throws java.lang.Exception  if a file can not be read.
     **/
