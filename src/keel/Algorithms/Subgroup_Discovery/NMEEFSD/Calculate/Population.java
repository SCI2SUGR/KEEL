...
public class Population {
     ...
     */
       ...
       * </p>
       * @param nameFileQua       Output quality file
       */
      public void CalcPob (String nameFileQua) {
          Result res;
          int i; 
          String contents;
          float sumComp=0;
         ...
         Files.writeFile(nameFileQua, contents);
      }
     ...
     * </p>
     * @param first       Position of an individual
     * @param second      Position of an individual
     * @return            The result of the comparison
     */
    public boolean Compare (int first, int second) {
        if (indivi[first].getNumClass() != indivi[second].getNumClass())
            return false;
        else {
            for (int i=0; i<indivi[first].getIndivSize(); i++) {
                if (!indivi[first].EqualTo(indivi[second]))
                    return false;
            }
        }
        return true;
