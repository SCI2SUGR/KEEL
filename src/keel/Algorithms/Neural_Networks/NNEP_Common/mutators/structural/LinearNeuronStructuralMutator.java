...
public class LinearNeuronStructuralMutator implements INeuronStructuralMutator<LinearNeuron> {
	...
	public LinearNeuronStructuralMutator() 
	{
		super();
	}
	...
	public void addNeuron(LinearNeuron neuron, LinkedLayer layer, ILayer<? extends INeuron> previousLayer, 
	...
	public void unitNeuronsWeights(LinearNeuron firstNeuron, LinearNeuron secondNeuron, LinkedLayer layer, LinkedLayer nextLayer, 
