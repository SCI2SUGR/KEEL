...
public class ExpNeuronStructuralMutator implements INeuronStructuralMutator<ExpNeuron> {
	...
	public ExpNeuronStructuralMutator() 
	{
		super();
	}
	...
	public void addNeuron(ExpNeuron neuron, LinkedLayer layer, ILayer<? extends INeuron> previousLayer, 
	...
	public void unitNeuronsWeights(ExpNeuron firstNeuron, ExpNeuron secondNeuron, LinkedLayer layer, LinkedLayer nextLayer, 
