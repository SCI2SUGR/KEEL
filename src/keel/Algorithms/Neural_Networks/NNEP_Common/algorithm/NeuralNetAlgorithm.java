...
public class NeuralNetAlgorithm<I extends IIndividual> extends AbstractAlgorithm<I> implements IPopulation<I>, IConfigure
{
	...
	public void doInit()
	{
		...
		//System.out.println("Inicialización " + (t2-t1));
	...
	protected void doGeneration() 
	{
		...
		//long t2 = System.currentTimeMillis();
		//System.out.println("Mutaci�n Estructural => " + (t2-t1));
		
		// Evaluate individuals
		//t1 = System.currentTimeMillis();
		evaluator.evaluate(cset);
		//t2 = System.currentTimeMillis();
		//System.out.println("Evaluaci�n Estructural => " + (t2-t1));
		...
		//t2 = System.currentTimeMillis();
		//System.out.println("Mutaci�n Param�trica => " + (t2-t1));
		
		// Evaluate individuals
		//t1 = System.currentTimeMillis();
		evaluator.evaluate(cset);
		//t2 = System.currentTimeMillis();
		//System.out.println("Evaluaci�n Param�trica => " + (t2-t1));
	}
