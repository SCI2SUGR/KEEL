 ...
 * <p>
 * @file RBFUtils.java
 * @author Writen by Victor Manuel Rivas Santos (University of Jaén) 22/07/2004
...
*/
    ...
    * </p>
    * @param _a1 First array
    * @param _a2 Second array
    * @param _nDatos Number of used data in the arrays (can be lower than _a1.length)
    * @return Number of elements that match.
    */
     public static int computeMatches( int [] _a1, int [] _a2, int _nDatos) {
      int toRet=0;
			for( int j=0; j<_nDatos; ++j ) {
				if ( _a1[j]==_a2[j] ) {
					++toRet;
				}
			}
