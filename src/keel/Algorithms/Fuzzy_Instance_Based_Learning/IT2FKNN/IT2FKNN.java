...
public class IT2FKNN extends FuzzyIBLAlgorithm {
	...
	private int kMax; //Maximum k value for K-NN in membership assignment
	...
	protected void readParameters(String script) {
	    ...
	    //Getting the kMax parameter
		line = fileLines.nextToken();
		tokens = new StringTokenizer (line, "=");
		tokens.nextToken();
		kMax = Integer.parseInt(tokens.nextToken().substring(1));
