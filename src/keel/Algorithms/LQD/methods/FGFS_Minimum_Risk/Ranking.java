...
public class Ranking {
	...
	static int centroide(fuzzy o1, fuzzy o2)
	{
	...
	static double value_x(fuzzy o1)
	{
		if(o1.es_crisp()==1)
			return o1.a;
		else
		{
			return (Math.pow(o1.d,2)+Math.pow(o1.c,2)+(o1.c*o1.d)-Math.pow(o1.a,2)-Math.pow(o1.b,2)-(o1.a*o1.b))/(3*(o1.d+o1.c-o1.a-o1.b));
		}
	}
