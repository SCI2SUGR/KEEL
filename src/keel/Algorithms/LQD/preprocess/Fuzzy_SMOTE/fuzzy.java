...
public class fuzzy {
	 ...
	 static public fuzzy multi(fuzzy x, fuzzy y)
	{
		 ...
		 mul.borrosotrapezoidal(a1, b1, c1, d1);
		return mul;
	}
	 static public fuzzy abs(fuzzy x)
	 {
		 fuzzy mul = new fuzzy();
		 ...
		 mul= fuzzy.multi(x, unidad);
		 
		 
		 return mul;
		 
	 }
	 static public fuzzy neg(fuzzy x)
	 {
		 fuzzy mul = new fuzzy();
		 fuzzy unidad= new fuzzy(1);
		 if(x.a<0)
	 ...
	 static public fuzzy pow (fuzzy x, float numero)
	 {
		
		 fuzzy pow = new fuzzy();
		 pow.borrosotrapezoidal((float)Math.pow(x.a,numero), (float)Math.pow(x.b,numero),(float) Math.pow(x.c,numero),(float) Math.pow(x.d,numero));
		 
		 
		return pow;
		 
 	 }
	 static public fuzzy multinumber(float peso, fuzzy y)
		{
			 fuzzy mul = new fuzzy();
