...
public class KNN {
	 ...
	 * @return Class of the new instance
	 */	   
	public static int evaluacionKNN2 (int nvec, double conj[][], double real[][], int nominal[][], boolean nulos[][], int clases[], double ejemplo[], double ejReal[], int ejNominal[], boolean ejNulos[], int nClases, boolean distance, int vecinos[], double minDistanciasSal[], int votosSal[]) {
		  ...
		  for (i=0; i<vecinosCercanos.length; i++) {
			  vecinos[i] = vecinosCercanos[i];
                          minDistanciasSal[i] = minDistancias[i];
                  }
