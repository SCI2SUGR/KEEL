...
public class ClassifierADQuadratic {
	...
	*/
	...
	/**
	* <p>
	* In this method, a classifier is estimated using Quadratic Discriminant Analysis
	...
	* </p>
	*/ 
    private static void qda(boolean tty, ProcessConfig pc) {
        ...
        try {
            ...
            int nVariables=pd.getNvariables();   // Number of examples
            int nInputs=pd.getNinputs();     // Numero de entradas
            
            double[][] X = pd.getX();             // Input data
            int[] C = pd.getC();                  // Output data
			int [] Ct=new int[C.length];
            int nclas = pd.getNclasses();        // Number of classes
            ...
            double Cbin[][] = new double[nData][nclas];
            ...
            try {
                ...
                System.out.println("The dataset is not valid for this algorithm");
            ...
            try {
                ...
                System.out.println("The dataset is not valid for this algorithm");
				for (int i=0;i<Co.length;i++) Co[i]=-1;
                System.out.println(e.toString());
            }
     ...
     */ 
		public static void main(String args[]) {
			...
			ClassifierADQuadratic a=new ClassifierADQuadratic();
			a.qda(tty,pc);
		}
