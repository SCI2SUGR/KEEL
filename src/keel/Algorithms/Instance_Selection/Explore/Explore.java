...
//
//  Created by Salvador Garcï¿½a Lï¿½pez 1-8-2004.
...
public class Explore extends Metodo{
  ...
  public void ejecutar () {
    ...
    /*2ï¿½ part of ELGrow. Now, eliminate instances to see if the cost improves*/
    for (i=0; i<datosTrain.length; i++) {
    ...
    /*3ï¿½ part of Explore. Do 1000 randoms mutations and maintain the best results*/
    for (i=0; i<1000; i++) {
