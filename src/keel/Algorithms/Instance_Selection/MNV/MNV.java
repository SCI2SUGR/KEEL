...
//
//  Created by Salvador Garcï¿½a Lï¿½pez 22-2-2008.
...
public class MNV extends Metodo {
  ...
  public void ejecutar () {
    ...
    /*Algorithm body. We resort randomly the instances of T and compare with the rest of S.
     If an instance doesnï¿½t classified correctly, it is inserted in S*/
    do {
      continuar = false;
      for (i=0; i<datosTrain.length; i++) {
    ...
    /*RNN Process*/
    /*Inicializaciï¿½n del vector de instancias marcadas para su elminiaciï¿½n posterior*/
