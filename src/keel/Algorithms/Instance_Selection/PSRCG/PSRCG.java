...
//
//  Created by Salvador Garcï¿½a Lï¿½pez 1-6-2005.
    ...
    OutputIS.escribeSalida(ficheroSalida[1], test, entradas, salida, nEntradas, relation);
		 ...
		 trainPrediction = new int[conjS.length][1];	
                 ...
                 for ( i=0; i<conjS.length; i++) {
                     ...
                     trainPrediction[i][0] = KNN.evaluate(conjS[i],datosTrain, nClases[0], clasesTrain, 1);
                 }
		...
		for (i=0; i<realClass.length; i++) {
			...
			prediction[i][0]= KNN.evaluate(datosTest[i],conjS, nClases[0], clasesS, 1);
		}
