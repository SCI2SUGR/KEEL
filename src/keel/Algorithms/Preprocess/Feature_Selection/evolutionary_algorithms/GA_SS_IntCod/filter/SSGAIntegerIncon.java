...
/*
 * SSGAIntegerIncon.java
 *
 * Created on 28 de agosto de 2005, 12:21
 *
 */
 ...
 *
 *  Implementation of SS GA with integer encoding for features selection
 *  Using inconsistency ratio
 *
 *  Inputs: seed, nearest neighbours for KNN Classifier, population size, number of
 *          evaluations, number of selected features
 *  Encoding: Integer
