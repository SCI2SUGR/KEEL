...
package keel.Algorithms.Preprocess.Feature_Selection.nonevolutionary_algorithms.SA_MI_FS;
...
/**
 * <p>Simulated Annealing Algorithm
 * @author Written by Ignacio Robles Paiz (University of Granada) 23/06/2010
 * @version 1.0
 * @since JDK1.6
 * </p>
 ...
 */
     ...
     */
    private boolean[] neighbor(boolean featuresVector[]){
        ...
        if(cardinalidadCto(fv) == 0){ //zero selected features is not allowed
            toChange = Randomize.Randint(0,Attributes.getInputNumAttributes());
            fv[toChange] = true;

        }

        this.modifiedFeat = toChange;
