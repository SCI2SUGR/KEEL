...
public class GraspLVO {
     ...
     *  @param vector is a double vector with the accuracy of each feature
    ...
    private int[] mejoresKCaracteristicas(double vector[]){
        ...
        while(k<temp.length){
            ...
            /* set negative infinity to the accuracy of the best feature  */
    ...
    /** main method of GraspLVO for features selection. Uses the previous methods */    
    private void GRASP(){
        double cantidad[];
        ...
        /* selects the best-k features according to their accuracy (calculates with LVO Classifier) */
        ...
        for(i=0; i<featuresVector.length; i++){
            ...
            cantidad[i] = 1 - data.LVO(featuresVector);
        }
        ...
        while(varsSelec < params.numberOfFeatures){
            ...
            /* 'cantidad' array contains the accuracy of all features. We 
