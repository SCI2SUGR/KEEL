...
//*******************************************************************************************************************************
	...
	public static void main(String[] args) throws Exception{
		...
		if(Parameters.option.equals("new")){
			IMCSF_FILTER_2STEPS method = new IMCSF_FILTER_2STEPS();
			method.run();
		}
		
		else if(Parameters.option.equals("classic")){
			IMCSF_FILTER method = new IMCSF_FILTER();
			method.run();
		}
	}
