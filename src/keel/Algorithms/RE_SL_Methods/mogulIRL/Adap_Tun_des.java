...
class Adap_Tun_des {
        ...
        public Adap_Tun_des (MiDataset training, BaseR_Tun_des base, double valor_tau, int tipo) {
                int i;
        ...
        void Decodifica (double [] cromosoma) {
                ...
                for (i=0; i<base_reglas.n_reglas; i++) {
                        for (j=0; j<tabla.n_variables; j++) {
                                base_reglas.BaseReglas[i][j].x0 = cromosoma[3 * base_reglas.b_reglas[i][j]];
                                base_reglas.BaseReglas[i][j].x1 = cromosoma[3 * base_reglas.b_reglas[i][j]+1];
                                base_reglas.BaseReglas[i][j].x2 = cromosoma[3 * base_reglas.b_reglas[i][j]+1];
                                base_reglas.BaseReglas[i][j].x3 = cromosoma[3 * base_reglas.b_reglas[i][j]+2];
                                base_reglas.BaseReglas[i][j].y = 1;
                                base_reglas.BaseReglas[i][j].Etiqueta = "E" + i + j;
                                base_reglas.BaseReglas[i][j].Nombre = "x" + (j+1);
                        }
                }
        }
