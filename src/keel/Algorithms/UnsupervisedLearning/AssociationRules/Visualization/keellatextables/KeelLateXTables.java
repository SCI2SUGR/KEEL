...
public class KeelLateXTables {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            ArrayList<String> processedAlgorithms = new ArrayList();
            ...
            // Examples..
            ResultsProccessor p = new ResultsProccessor();
            p.parseXmlFile("./examples/FuzzyApriori-A.basketball/result0e0.txt", "FuzzyApriori-A");
            p.parseXmlFile("./examples/GeneticFuzzyApriori-A.basketball/result0s0e0.txt", "GeneticFuzzyApriori-A");
            p.parseXmlFile("./examples/GeneticFuzzyAprioriDC-A.basketball/result0s0e0.txt", "GeneticFuzzyAprioriDC-A");

            p.writeToFile("./examples/KeelLaTeXTables.tex");
            */
