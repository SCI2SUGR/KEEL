...
public class Gene {
	...
	private MinimumSupport minimumSupport;
	 ...
	 */
	public Gene(MinimumSupport minimum_support,MembershipFunction[] membership_functions) {
            this.setMinimumSupport(minimum_support);
            this.setMembershipFunctions(membership_functions);
	}

        private void setMinimumSupport(MinimumSupport minimum_support) {
		this.minimumSupport = minimum_support.clone();
	}
	...
	private void setMembershipFunctions(MembershipFunction[] membership_functions) {
        ...
        /**
	 * <p>
	 * It returns the minimum support of a gene
	 * </p>
	 * @return An array of minimum support for the gene being considered
	 */
	public MinimumSupport getMinimumSupport() {
	...
	public MembershipFunction[] getMembershipFunctions() {
        ...
        /**
	 * <p>
	 * It returns the number of membership functions of a gene
	 * </p>
	 * @return An integer with the number of membership functions
	 */
	public int getNumberOfMembershipFunctions() {
		return this.membershipFunctions.length;
	}
	 ...
	 */
	public Gene clone() {
		Gene gene = new Gene(this.minimumSupport,this.membershipFunctions);
