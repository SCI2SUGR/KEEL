...
public class GeneticFuzzyAprioriMS {
	/**
	 * <p>
    ...
    private GeneticFuzzyAprioriMSProcess proc;
     ...
     */
    public GeneticFuzzyAprioriMS(parseParameters parameters) {
        ...
        this.maximumMinimumSupport = Double.parseDouble(parameters.getParameter(6));
        this.useMaxForOneFrequentItemsets = Boolean.parseBoolean(parameters.getParameter(7));
        this.minConfidence = Double.parseDouble(parameters.getParameter(8));
        this.k = Integer.parseInt(parameters.getParameter(9));
        this.intervalThreshold = Double.parseDouble(parameters.getParameter(10));
        this.breakThreshold = Double.parseDouble(parameters.getParameter(11));
        this.pRNL = Double.parseDouble(parameters.getParameter(12));
    ...
    public void execute() {
        if (somethingWrong) { //We do not execute the program
        	...
        	this.proc = new GeneticFuzzyAprioriMSProcess(this.k,this.breakThreshold,this.intervalThreshold,this.pRNL, this.trans, this.nEvaluations, this.popSize, this.pm, this.pc, this.d, this.useMaxForOneFrequentItemsets, this.maximumMinimumSupport, this.minConfidence);
        	this.proc.run();
