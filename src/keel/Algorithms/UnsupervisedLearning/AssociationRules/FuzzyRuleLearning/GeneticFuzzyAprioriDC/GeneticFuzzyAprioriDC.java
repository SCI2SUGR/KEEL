...
public class GeneticFuzzyAprioriDC {
    ...
    private GeneticFuzzyAprioriDCProcess proc;
     ...
     */
    public GeneticFuzzyAprioriDC(parseParameters parameters) {
    ...
    public void execute() {
        if (somethingWrong) { //We do not execute the program
        	...
        	this.proc = new GeneticFuzzyAprioriDCProcess(this.trans, this.nEvaluations, this.popSize, this.pm, this.pc, this.d, this.nFuzzyRegionsForNumericAttributes, this.useMaxForOneFrequentItemsets, this.minSupport, this.minConfidence);
        	this.proc.run();
