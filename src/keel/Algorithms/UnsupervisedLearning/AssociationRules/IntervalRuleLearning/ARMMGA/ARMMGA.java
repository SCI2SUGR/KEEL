...
public class ARMMGA {
	 ...
	 */
	public ARMMGA(parseParameters parameters) { 
	...
	public void execute() {
		if (somethingWrong) { //We do not execute the program
			...
			this.ap = new ARMMGAProcess(this.trans, this.dataBase, this.nTrials, this.popsize, this.kItemsets, this.ps, this.pc, this.pm, this.alpha);
			this.ap.run();
			this.assoc_rules = this.ap.getRules();      	
			try {
				...
				valueOrder_writer.print(this.ap.printRules(this.assoc_rules));
				valueOrder_writer.println("</values>");
