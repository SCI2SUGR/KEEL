package keel.Algorithms.MIL.MIDD_Clas;
 ...
 * <p>Description: It contains the essential methods for the MIDD algorithm</p>
...
public class MIDD {
     ...
     */
    public MIDD(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
        ...
        classifierName = "weka.classifiers.mi.MIDD";
    ...
    /**
     * We execute here the MIDD algorithm and we create the necessary output data
     */
    public void execute() {
    ...
    /**
     * Main process of the MIDD algorithm
     */
    private void algorithmMIDD() {
	...
	private void writeOutput( ) {
		...
		try {
			...
			//Read to bag relational attributes
