package keel.Algorithms.MIL.CitationKNN_Clas;
 ...
 * <p>Description: It contains the essential methods for the CitationKNN algorithm</p>
...
public class CitationKNN {
     ...
     */
    public CitationKNN(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
              String fsal, long seed, int citers, int references) {
        ...
        String [] auxOptions = {"-R", String.valueOf(references), "-C", String.valueOf(citers), "-H", "1"};
        options = auxOptions;
        
        classifierName = "weka.classifiers.mi.CitationKNN";
     ...
     */
    private void algorithmCitationKNN() {
    	...
    	Classifier classifier;
 		try {
 	        ...
 	        //Obtain information from model generated
	...
	private void writeOutput( ) {
		...
		try {
			...
			//Read to bag relational attributesç
