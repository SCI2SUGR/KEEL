...
/**
 * <p>Title: CitationKNN Main Program</p>
...
public class Main {
    ...
    private void preparaArgumentos(String nomFichero) {
        ...
        datos = new StringTokenizer(una_linea, " = \" ");
        datos.nextToken();
        citers = Integer.parseInt(datos.nextToken());
        una_linea = linea.nextToken();
        datos = new StringTokenizer(una_linea, " = \" ");
        datos.nextToken();
        references = Integer.parseInt(datos.nextToken());
    };

    /**
     * It launches the CitationKNN program
     */
    private void execute() {
        CitationKNN mi_aq = new CitationKNN(ficheroTrain, ficheroEval, ficheroTest,
                          ficheroSalidatr, ficheroSalidatst, ficheroSalida,
                          semilla, citers, references);
