...
public class Main {
	public static void main(String args[]) {
		...
		try {
			...
			CKNN algorithm = new CKNN();
			
			algorithm.setNumberCiters(Integer.parseInt(props.getProperty("number-citers")));
			algorithm.setNumberReferences(Integer.parseInt(props.getProperty("number-references")));
