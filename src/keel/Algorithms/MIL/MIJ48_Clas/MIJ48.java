package keel.Algorithms.MIL.MIJ48_Clas;
...
public class MIJ48 {
     ...
     */
    public MIJ48(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
        ...
        String [] auxOptions = {"-P", String.valueOf(value), "-A", "0", "-W", "weka.classifiers.trees.J48", "--", "-C", "0.25", "-M", "2"};                                                                     
        options = auxOptions;
