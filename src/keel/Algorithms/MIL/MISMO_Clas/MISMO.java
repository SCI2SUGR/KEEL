package keel.Algorithms.MIL.MISMO_Clas;
...
public class MISMO {
     ...
     * @param filter Filter used for the data.
     * @param kernel Kernel used.
     */
    public MISMO(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
              String fsal, long seed, String filter, String kernel) {
        ...
        if(kernel.equals("MIPolyKernel")){
        	String [] auxOptions = {"-C", "1.0", "-L", "0.0010", "-P", "1.0E-12", "-N", String.valueOf(value), "-V", "-1", "-W", "1", "-K", "weka.classifiers.mi.supportVector.MIPolyKernel"}; //, "-C", "250007", "-E", "1.0"};
            options = auxOptions;
            
            classifierName = "weka.classifiers.mi.MISMO";	
        }
        else{
       
        		String [] auxOptions = {"-C", "1.0", "-L", "0.0010", "-P", "1.0E-12", "-N", String.valueOf(value), "-V", "-1", "-W", "1", "-K", "weka.classifiers.mi.supportVector.MIRBFKernel"}; // "-C", "250007", "-G", "0.01"};
                options = auxOptions;
