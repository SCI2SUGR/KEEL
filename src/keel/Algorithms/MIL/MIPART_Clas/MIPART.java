...
public class MIPART {
     ...
     */
    public MIPART(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
        ...
        String [] auxOptions = {"-P", String.valueOf(value), "-A", "0", "-W", "weka.classifiers.rules.PART", "--", "-M", "2", "-C", "0.25", "-Q", "1"};
        options = auxOptions;
