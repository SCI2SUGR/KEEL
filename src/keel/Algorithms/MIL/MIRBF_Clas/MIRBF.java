package keel.Algorithms.MIL.MIRBF_Clas;
...
public class MIRBF {
     ...
     */
    public MIRBF(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
              String fsal, long seed, String method) {
        ...
        int value;
        if(method.equals("Arithmetic Average"))
        		value = 1;
        else if(method.equals("Geometric Average"))
        		value = 2;
        else
        	value =3;
        ...
        String [] auxOptions = {"-P", String.valueOf(value), "-A", "0", "-W", "weka.classifiers.functions.RBFNetwork", "--", "-B", "2", "-S", "1", "-R", "1.0E-8", "-M", "-1", "-W", "0.1"};
        options = auxOptions;
        
        classifierName = "weka.classifiers.mi.MIWrapper";
     ...
     */
    private void algorithmMIWrapper() {
