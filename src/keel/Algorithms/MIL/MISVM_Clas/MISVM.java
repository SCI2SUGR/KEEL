package keel.Algorithms.MIL.MISVM_Clas;
...
public class MISVM {
     ...
     */
    public MISVM(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
        ...
        //	 String [] auxOptions = {"-C", "1.0", "-N", String.valueOf(value), "-K", "weka.classifiers.mi.supportVector.MIPolyKernel"}; //, "-C", "250007", "-E", "1.0"};
         //    options = auxOptions;
             
         //    classifierName = "weka.classifiers.mi.MISVM";
         //}
        //else
        //{
        //	String [] auxOptions = {"-C", "1.0", "-N", String.valueOf(value), "-K", "weka.classifiers.mi.supportVector.MIRBFKernel"}; //, "-C", "250007", "-G", "0.01"};
        //    options = auxOptions;
