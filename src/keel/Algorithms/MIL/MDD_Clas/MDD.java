package keel.Algorithms.MIL.MDD_Clas;
 ...
 * <p>Description: It contains the essential methods for the MDD algorithm</p>
...
public class MDD {
     ...
     * @param filter It is the filter used in the data
     */
    public MDD(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
              String fsal, long seed, String filter) {
        ...
        int value;
        if(filter.equals("Normalize Training Data"))
        		value = 0;
        else if(filter.equals("Standardize Training Data"))
        		value = 1;
        else
        	value =2;
          
        String [] auxOptions = {"-N", String.valueOf(value)};
        options = auxOptions;
        
        classifierName = "weka.classifiers.mi.MDD";
    ...
    /**
     * We execute here the MDD algorithm and we create the necessary output data
     */
    public void execute() {
    ...
    /**
     * Main process of the MDD algorithm
     */
    private void algorithmMDD() {
    	...
    	Classifier classifier;
 		try {
 	        ...
 	        //Obtain the information from model generated
	...
	private void writeOutput( ) {
		...
		try {
			...
			//Read to relational bag attributes
			...
			//Prepare the training output file
