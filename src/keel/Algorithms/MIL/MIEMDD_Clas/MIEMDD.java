package keel.Algorithms.MIL.MIEMDD_Clas;
 ...
 * <p>Description: It contains the essential methods for the MIEMDD algorithm</p>
...
public class MIEMDD {
     ...
     */
    public MIEMDD(String ftrain, String feval, String ftest, String foutputTr,
              String foutputTst,
        ...
        String [] auxOptions = {"-S", String.valueOf(seed), "-N", String.valueOf(value)};
        options = auxOptions;
        
        classifierName = "weka.classifiers.mi.MIEMDD";
    ...
    /**
     * Main process of the MIEMDD algorithm
     */
    private void algorithmMIEMDD() {
    	...
    	Classifier classifier;
 		try {
 	        ...
 	        //Obtain data from the model generated
