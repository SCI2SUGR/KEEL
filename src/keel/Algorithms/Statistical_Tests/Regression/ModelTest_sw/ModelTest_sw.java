...
package keel.Algorithms.Statistical_Tests.Regression.ModelTest_sw;
...
/**
* <p>This class has only a main method that calls Shapiro Wilk test for regression problems, defined in StatTest
	* 
...
public class ModelTest_sw {
	...
	*/
	public static void main(String args[]) {
		...
		pl.statisticalTest(StatTest.ShapiroWilkR,tty,pc);
