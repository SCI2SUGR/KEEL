...
package keel.Algorithms.Statistical_Tests.Regression.Model_Tabular;
...
/**
* <p> This class has only a main method that calls Model_Tabular output method for regression problems, defined in StatTest
	* 
...
public class Model_Tabular {
	...
	*/	
	public static void main(String args[]) {
		...
		pl.statisticalTest(StatTest.tabularR,tty,pc);
