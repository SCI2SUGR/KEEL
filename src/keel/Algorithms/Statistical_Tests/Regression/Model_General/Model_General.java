...
package keel.Algorithms.Statistical_Tests.Regression.Model_General;
...
/**
* <p>This class has only a main method that calls Model_General output method for regression problems, defined in StatTest
	* 
...
public class Model_General {
	...
	*/
	public static void main(String args[]) {
		...
		pl.statisticalTest(StatTest.generalR,tty,pc);
