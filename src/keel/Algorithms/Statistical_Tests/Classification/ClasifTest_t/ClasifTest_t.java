...
package keel.Algorithms.Statistical_Tests.Classification.ClasifTest_t;
...
/**
* <p>This class has only a main method that calls t test for classification problems, defined in StatTest
	* 
...
public class ClasifTest_t {
	...
	*/	
	public static void main(String args[]) {
		...
		pl.statisticalTest(StatTest.tC,tty,pc);
