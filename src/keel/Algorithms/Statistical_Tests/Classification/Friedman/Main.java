...
public class Main {
	/**
	* <p>
	* This class has only a main method that calls Friedman test for classification problems, defined in StatTest
	* </p>
	*/
	...
	* Friedman test for classification problems, defined in StatTest class
