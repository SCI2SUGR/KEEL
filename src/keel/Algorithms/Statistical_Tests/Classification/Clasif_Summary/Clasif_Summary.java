...
package keel.Algorithms.Statistical_Tests.Classification.Clasif_Summary;
...
/**
* <p> This class has only a main method that calls Model_Summary output method for classification problems, defined in StatTest
	* 
...
public class Clasif_Summary {
	...
	*/	
	public static void main(String args[]) {
		...
		pl.statisticalTest(StatTest.summaryC,tty,pc);
