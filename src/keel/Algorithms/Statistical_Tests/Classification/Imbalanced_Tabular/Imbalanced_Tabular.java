...
package keel.Algorithms.Statistical_Tests.Classification.Imbalanced_Tabular;
...
/**
* <p>This class has only a main method that calls Model_Tabular output method for classification problems, defined in StatTest
	* 
...
* </p>
*/
public class Imbalanced_Tabular {
	...
	*/	
	public static void main(String args[]) {
		...
		pl.statisticalTest(StatTest.tabularI,tty,pc);
