...
public class ProcessConfig {
    ...
    void doTableType1(StringTokenizer tokens) throws SyntaxError {
        if (!tokens.hasMoreTokens()) {
            throw new SyntaxError("Eleccion de la tabla 1 no especificada");
        }
        String tmp = tokens.nextToken();
        while (!tmp.equals("=")) {
            tmp = tokens.nextToken();
    ...
    void doTableType2(StringTokenizer tokens) throws SyntaxError {
        if (!tokens.hasMoreTokens()) {
            throw new SyntaxError("Eleccion de la tabla 2 no especificada");
        }
        String tmp = tokens.nextToken();
        while (!tmp.equals("=")) {
            tmp = tokens.nextToken();
    ...
    void doTableType3(StringTokenizer tokens) throws SyntaxError {
        if (!tokens.hasMoreTokens()) {
            throw new SyntaxError("Eleccion de la tabla 3 no especificada");
        }
        String tmp = tokens.nextToken();
        while (!tmp.equals("=")) {
            tmp = tokens.nextToken();
    ...
    void doNumberLine(StringTokenizer tokens) throws SyntaxError {
        if (!tokens.hasMoreTokens()) {
            throw new SyntaxError(
                    "Eleccion del numero de lineas no especificada");
        }
        String tmp = tokens.nextToken();
        while (!tmp.equals("=")) {
            tmp = tokens.nextToken();
