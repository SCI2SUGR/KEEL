...
/** 
* <p> 
* ClassifierFuzzyAdaBoost generates a Fuzzy Rule Based System classifier using 
* the Ada Boosting algorithm. This class acts as an interface for the FB (Fuzzy 
...
*/ 	
	private static void fuzzyBoosting(int opt,boolean tty, ProcessConfig pc) {
		...
		try {
			...
			int[] nInputPartitions=new int[nInputs]; // Partition Linguistic labels
