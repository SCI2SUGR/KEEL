...
public class variable_t implements Cloneable {
	...
	public void Assign (int n, String varname, int status, double inf, double sup, double[] a, double[] b, double[] c, double[] d, String[] name){
	 ...
	 public void Set (int n, double inf, double sup, boolean menosinf, boolean masinf, String name){
	    this.nombre = name;
	    this.activa = true;
	    this.antecedente = true;
	    this.dominio = new domain_t [1];
	    this.dominio[0] = new domain_t ();
	    this.dominio[0].Assign (n, inf, sup, menosinf, masinf);
	  }
	 ...
	 public void Set (String name, int n, String[] nombres, double[] ident){
	    ...
	    this.dominio = new domain_t [1];
	    this.dominio[0] = new domain_t ();
	    this.dominio[0].Assign (n, 0, 0, ident, ident, ident, ident, nombres);
	  }
