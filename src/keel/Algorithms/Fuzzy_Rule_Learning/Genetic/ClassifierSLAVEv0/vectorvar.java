...
public class vectorvar {
	...
	private static boolean Is_Number (String cadena){
		try {
	...
	private static boolean Check_Values (String[] cadena, int etiq){
	...
	private static String[] Normalize_String (String[] cadena){
	...
	private static String Store_Variable (String linea, double[] va, double[] vb, double[] vc, double[] vd, String[] vname, Double_t inf, Double_t sup, boolean antecedente, int clases, int numero_etiquetas){
		final int MAX_VAL_ENTEROS = 10;
	...
	private static double Calculate_Increase (double inf, double sup){
		double resultado;
	...
	public boolean Is_Valid (String regla, Double_t simplicidad){
		String sub;
		int trozo = 0, tam;
