 ...
 * <p>Title: Data Base</p>
 *
 * <p>Description: It contains Data Base</p>
 *
 *
 * <p>Company: KEEL </p>
 *
...
class BaseD {
    ...
    public Difuso getParticion(int i, int j) {
        return ((Difuso)BaseDatos[i][j]).copia();
    }

    public double AntecedenteCubreEjemplo(int[] AntRegla, double[] ejem)
    /* Computes the compatibility degree (Ri(ek)) of the antecedents of the rule with the example */
    {
        int i;
