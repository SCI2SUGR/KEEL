...
/**
 * <p>Class for management of nodes that are evaluated to a vector of fuzzy numbers. Internal Node (usually root node). It's evaluated to vector of fuzzy numbers	
