...
/**
 * <p>Class for management nodes with the number of the variable and the value of
 * the variable as a string. 
 * It's evaluated to a fuzzy constant GAP implementation requires, this node must contains a pointer to a fuzzy set instead a copy. You must remove every calling to "Clona"   
