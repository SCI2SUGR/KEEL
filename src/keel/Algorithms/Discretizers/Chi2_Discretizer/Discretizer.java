 ...
 * 
 * A general framework for Chi Discretizers.
...
public abstract class Discretizer {
    ...
    /**
     * Inconsistency Threshold. Chi sigma parameter.
     */
     ...
     * @return the inconsistency percentage of the given instances.
     */
     ...
     * its values for each instances given. Every Chi discretizer should implement
     ...
     * its values for each instances given without sigma level. Every Chi discretizer should implement
     * this method with its particular scheme.
     * @param attribute given attribute to discretize.
     * @param values given attribute values in the dataset.
     * @param intervals given intervals.
     ...
     * @return the discretized intervals of the given attribute.
     */
