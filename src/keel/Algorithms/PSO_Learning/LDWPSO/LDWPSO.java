...
public class LDWPSO {
     ...
     */
    public LDWPSO(parseParameters parameters) {
        ...
        maxIterations = Integer.parseInt(parameters.getParameter(2));
        ...
        wmax = Double.parseDouble(parameters.getParameter(7));
        wmin = Double.parseDouble(parameters.getParameter(8));
