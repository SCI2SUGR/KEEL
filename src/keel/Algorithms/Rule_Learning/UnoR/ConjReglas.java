...
public class ConjReglas {
    ...
    /**
     * A�de todo un conjunto de reglas a la lista
    ...
    /**
     * A�de una regla a la lista
     * @param regl Regla a a�dir
     */
    ...
    /**
     * Vac� el contenido del conjunto de reglas
     */
     ...
     * @return El tama� del conjunto de reglas
     */
    public int size() {
        return (reglas.size());
    }
     ...
     * @param tam Tama� de las estrella
     */
    ...
    /**
     * Elimino reglas que sean sem�ticamente iguales (At = 1, At <> 0, At = [0,1])
     * @param tam int Tama� de la estrella
     */
