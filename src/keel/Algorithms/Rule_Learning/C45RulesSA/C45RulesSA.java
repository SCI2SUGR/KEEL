...
/**
 * <p>
 * Class to implement the C4.5Rules (Simulated Anneling version) algorithm
 * </p>
 */
   ...
   */
  public C45RulesSA(Tree root, parseParameters parameters){
    this.root=root;
    ...
    Nmax=Integer.parseInt(parameters.getParameter(4)); //
    max_trials=Integer.parseInt(parameters.getParameter(5)); //
    mu=Double.parseDouble(parameters.getParameter(6));
    phi=Double.parseDouble(parameters.getParameter(7));
    alpha=Double.parseDouble(parameters.getParameter(8));
    if (Nmax<=0){
      Nmax=10;
      System.err.println("Error: nColdings must be greater than 0");
      System.err.println("Using default value: 10");
    }
    if (max_trials<=0){
      max_trials=10;
      System.err.println("Error: maxTrialsPerTemperature must be greater than 0");
      System.err.println("Using default value: 10");
    }
    if (mu<0 || mu>1){
      mu=0.5;
      System.err.println("Error: mu must be in the interval [0,1]");
      System.err.println("Using default value: 0.5");
    }
    if (phi<0 || phi>1){
      phi=0.5;
      System.err.println("Error: phi must be in the interval [0,1]");
      System.err.println("Using default value: 0.5");
    }
    if (alpha<0 || alpha>1){
      alpha=0.5;
      System.err.println("Error: alpha must be in the interval [0,1]");
      System.err.println("Using default value: 0.5");
    }
