 ...
 */
  ...
  static String algorithmName = "MPLCS";
  ...
  */
  ...
  static boolean isReal(String paramName) {
    ...
    if (paramName.equalsIgnoreCase("probLocalSearch")) {
        return true;
      }
    
    if (paramName.equalsIgnoreCase("probRSWcrossover")) {
        return true;
      }
    ...
    if (paramName.equalsIgnoreCase("filterSmartCrossover")) {
        return true;
      }
  ...
  static boolean isInteger(String paramName) {
    ...
    if (paramName.equalsIgnoreCase("numParentsRSWcrossover")) {
        return true;
      }
    
    if (paramName.equalsIgnoreCase("repetitionsRuleOrdering")) {
        return true;
      }
  ...
  static boolean isBoolean(String paramName) {
    ...
    if (paramName.equalsIgnoreCase("doRuleCleaning")) {
        return true;
     }
    
    if (paramName.equalsIgnoreCase("doRuleSplitting")) {
        return true;
     }
    
    if (paramName.equalsIgnoreCase("doRuleGeneralizing")) {
        return true;
     }
