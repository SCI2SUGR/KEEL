 ...
 * <p>Descripción: Clase muestra.
 *    Contiene una linea del fichero, cada linea tiene una muestra de la forma
 *    condiciones => clase </p>
...
public class Muestra {
    ...
    /**
     *  Constructor
     *  Crea una muestra a partir de los atributos y la clase que se le pasan
     *  por parametro.
     *
    ...
    /**
     * Modulo que inserta un atributo junto con su valor en la muestra
     *
     * @param original Atributo Atributo que se inserta en la muestra.
     */
    ...
    /**
     * Modulo que inserta la clase a la que identifica la muestra con todos
     * sus atributos
     *
     * @param original Atributo Clase que se inserta en la muestra
     */
    ...
    /**
     * Funcion que avisa si un atributo esta ya junto con su valor en una muestra
     *
