...
public class ParametersParser {
     ...
     * @return the parameters obtained (HashMap<String, String>).
     */
     ...
     * @param paramName given parameter name.
     * @return the parameter value of a given parameter name.
     */
