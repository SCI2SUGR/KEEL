 ...
 */	
    ...
    public void readClassificationSet(String datasetFile, boolean train) throws
        ...
        try {
            ...
            nominales = new Vector<String>();
            nominales = Attributes.getOutputAttribute(0).getNominalValuesList();
     ...
     */            
    public int numberInstances(String clas) {
        int code = nominales.indexOf(clas);
        return instancesCl[code];
    }
