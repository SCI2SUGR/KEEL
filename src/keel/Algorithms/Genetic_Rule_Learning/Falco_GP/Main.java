...
package keel.Algorithms.Genetic_Rule_Learning.Falco_GP;
...
public class Main
{
	...
	private static void configureJob(String jobFilename) {
		...
		algConf.addProperty("process[@algorithm-type]", "net.sourceforge.jclec.problem.classification.falco.FalcoAlgorithm");
		...
		algConf.addProperty("process.species[@type]", "net.sourceforge.jclec.problem.classification.falco.FalcoSyntaxTreeSpecies");
		algConf.addProperty("process.evaluator[@type]", "net.sourceforge.jclec.problem.classification.falco.FalcoEvaluator");
		...
		algConf.addProperty("process.recombinator.base-op[@type]", "net.sourceforge.jclec.problem.classification.falco.FalcoCrossover");
		...
		algConf.addProperty("process.mutator.base-op[@type]", "net.sourceforge.jclec.problem.classification.falco.FalcoMutator");	
		algConf.addProperty("process.copy-prob", Double.parseDouble(props.getProperty("copy-prob")));
		algConf.addProperty("process.listener[@type]", "net.sourceforge.jclec.problem.classification.falco.KeelFalcoPopulationReport");
