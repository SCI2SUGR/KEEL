...
public class Dataset {
  ...
  public String getTiposIndex(int index) {
    ...
    if ( (tipo == Attributes.getAttribute(0).INTEGER) ||
        (tipo == Attributes.getAttribute(0).REAL)) {
      return "real";
    }
    return "enumerado";
  }
  ...
  public String getTiposIndex2(int index) {
    ...
    //if (tipo == Attributes.getAttribute(0).INTEGER)
    //return "integer";
    //else if (tipo == Attributes.getAttribute(0).REAL){
    //return "real";
    //}
    //return "enumerado";
    //if (index != indexClass) {
    if (index != this.getNvariables()-1){
      return "real";
    }
    else {
      return "enumerado";
  ...
  public void readClassificationSet(String datasetFile, boolean train) throws
    ...
    for (indexClass = 0;
         ...
         (! (Attributes.getOutputAttribute(0).
             getName().equalsIgnoreCase(atts[indexClass].getName())));
         indexClass++) {
      ;
    }
  }
  ...
  public boolean hasMissingAttributes() {
    return (this.sizeWithoutMissing() < this.getNdatos());
  }
    ...
    for (int i = 0; i < nVars; i++) {
      ...
      //if (this.getTiposIndex(i).equals("real")) {
        ...
        if (i == nVars -1){
          ...
          for (int j = 0; j < Attributes.getAttribute(i).getNumNominalValues();
               j++) {
