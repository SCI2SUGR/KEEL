...
public class ACO {
   ...
   * @param fStop String Nombre del fichero con los datos del conjnto de parada
   ...
   * @param alfaIn float Parametro alfa
   * @param betaIn float Parametro beta
...
//------------------------------------------------Datos TEST
   ...
   * @param hormiga Hormiga a la cual hay que crearle un camino
   */
