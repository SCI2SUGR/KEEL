...
public class Main {
  ...
  private int postpoda;
    ...
    private void preparaArgumentos(String nomFichero){
      ...
      datos = new StringTokenizer(una_linea," = \" ");
      datos.nextToken();
      N = Integer.parseInt(datos.nextToken()); //número de reglas
      una_linea = linea.nextToken(); //Leo una linea
      datos = new StringTokenizer(una_linea," = \" ");
    ...
    private void ejecutar(){
        apriori algoritmo = new apriori(ficheroTrain,ficheroEval,ficheroTest,ficheroSalidatr,ficheroSalidatst,ficheroSalida,Smin,Cmin,N,postpoda);
  ...
  public static void main(String args[]) {
    ...
    Main aprioriC = new Main();

    aprioriC.preparaArgumentos(args[0]); //Solo cogere el primer argumento (nombre del fichero)

    System.err.println("Executing APRIORI.");
