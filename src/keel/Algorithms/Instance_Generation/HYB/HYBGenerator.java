...
//import keel.Algorithms.Instance_Generation.LVQ.*; Este será el SVM
...
public class HYBGenerator extends PrototypeGenerator {
    ...
    public PrototypeSet reduceSet()
    {
        ...
        Debug.errorln("Tama�o " + initialSet.size());
        ...
        //Debug.errorln("Tama�o Tplacement " + TpGlobal.size());
        //Debug.errorln("Tama�o Toptimization " + ToGlobal.size());
        double bestE = initE;
        double bestW = initW;
