...
class Tun_aprox {
	...
	public void leer_conf (){
		...
		fun_adap = new Adap(tabla, base_reglas, tau, 1);
		alg_gen = new AG(long_poblacion, cruce, mutacion, a, b, fun_adap);
	    }
	}
	...
	public void run () {
		...
		Fichero.AnadirtoFichero(ruta_salida + "tunaproxcomunR.txt", "" + base_reglas.n_reglas + "\n");
