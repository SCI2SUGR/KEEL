...
/**
 * <p>Title: the Main class of the algorithm</p>
 *
...
public class Chc {
	...
	/*INICIALIZA VARIABLES*/
	  ...
	  public void main(int long_tabla_tra,double[][] vtra,double []stra,int long_tabla_tst,double[][] vtest,double []stst,int num,int reglas, int var, double sal,double []v,int pop, int bits,long semilla, String fich) {
	  ...
	  /* ENTRADA DE DATOS */
		  ...
		  ec_tst = P.getE().ECM_tst(P.getBEST_CROM().Gene());
