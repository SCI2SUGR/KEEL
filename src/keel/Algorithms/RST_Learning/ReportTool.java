...
public class ReportTool{
	...
	public static void printReport(){
		...
		double redIS,redFS, redIFS;
		int instances[], features[];
		...
		redIS=KNNClassifier.computeISReduction();
		redFS=KNNClassifier.computeFSReduction();
		
		redIFS=1.0 - ( (1.0-redIS)* (1.0-redFS)) ;
		...
		text+= "Instances Selected:\n"+aux+"\n";
		
		//Features selected
		features=KNNClassifier.getFS();
