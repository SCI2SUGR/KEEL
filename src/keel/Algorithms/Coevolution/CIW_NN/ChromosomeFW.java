...
/**
 * 
 * File: ChromosomeFW.java
 * 
 * A chromosome implementation for FW population
 * 
...
class ChromosomeFW implements Comparable{
	 ...
	 */
	@Override
	public ChromosomeFW clone(){
		
		ChromosomeFW clon=new ChromosomeFW();
	 ...
	 * @return Offspring
	 */
	public ChromosomeFW BLX(ChromosomeFW second, double alpha){
	...
	public int compareTo(Object o) {
		...
		ChromosomeFW other= (ChromosomeFW)o;
