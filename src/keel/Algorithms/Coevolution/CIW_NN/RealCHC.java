 ...
 * File: RealCHC.java
 * 
 * A real-coded implementation of the CHC algorithm, for the FW population
 * 
...
class RealCHC {
	 ...
	 * 
	 * @param population FW population
	 * 
	 * @return Amount of evaluations spent
	 */
	public static int generation(ChromosomeFW [] population){
		
		int candidate1,candidate2;
		int selected1, selected2;
		ChromosomeFW one,two,three,four,elite;
		double value;
		double time;
	 ...
	 */
	private static double evaluateFitness(ChromosomeFW a){
		
		double acc;
		
		WKNN.setFeatureWeights(a.getAll());
		acc=WKNN.accuracy();
		evals++;
