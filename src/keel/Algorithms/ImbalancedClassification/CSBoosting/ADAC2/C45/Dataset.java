...
package keel.Algorithms.ImbalancedClassification.CSBoosting.ADAC2.C45;
...
public class Dataset {
    ...
    private boolean getItemsetFull() {
       ...
       double peso[] = new double[ IS.getNumInstances()];
       double total = 0;
       for (int j = 0; j < IS.getNumInstances(); j++) {
            peso[j] = 1;//Math.random();
            total += peso[j];
       }
       double total2 = 0;
       for (int j = 0; j < IS.getNumInstances(); j++) {
            peso[j] /= total;
            peso[j] *= IS.getNumInstances();
            total2 += peso[j];
       }
       // System.out.println("total2: " + total2);
        ...
        for (int j = 0; j < IS.getNumInstances(); j++) {
           ...
           // System.out.println("rand: " + Math.random());
            addItemset(new Itemset(peso[j], itemset));
    ...
    private boolean getItemsetFull(double[] weights) {
      ...
      //  System.out.println("total2: " + total2);
        ...
        for (int j = 0; j < IS.getNumInstances(); j++) {
           ...
           // System.out.println("rand: " + Math.random());
            addItemset(new Itemset(weights[j], itemset));
            //addItemset(new Itemset(1, itemset));
