...
public class Metodo {
	...
	public Metodo (String ficheroScript) {
		...
		readConfiguration (ficheroScript);
                
                ficheroTraining = multi_C45.outputTr.substring(0,multi_C45.outputTr.length()-4) + "training2.txt";
                ficheroTest = multi_C45.outputTr.substring(0,multi_C45.outputTr.length()-4) + "training2.txt";
                
                
                ficheroSalida[0] = multi_C45.outputTr.substring(0,multi_C45.outputTr.length()-4) + "training.txt";
                ficheroSalida[1] = multi_C45.outputTr.substring(0,multi_C45.outputTr.length()-4) + "tstOutput.txt";
